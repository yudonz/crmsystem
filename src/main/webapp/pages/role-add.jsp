    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/role/role-list/1/2">角色管理</a></li>
        ...
        <script>
            $(function () {
                $('#save').click(function () {
                	if($('input[name="roleName"]').eq(0).val()==''){
                		alert("角色名称不能为空");
                		return;
					}
					if($('input[name="roleDesc"]').eq(0).val()==''){
						alert("角色描述不能为空");
						return;
					}
                    $.post('${pageContext.request.contextPath}/role/save.do', {
                        roleName: $('input[name="roleName"]').eq(0).val(),
