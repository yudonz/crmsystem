    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/permission/permission-list">资源权限管理</a></li>
        ...
        <script>
            $(function () {
                $('#btn').click(function () {
                    $.post('${pageContext.request.contextPath}/permission/save', {
                        permissionName: $('input[name="permissionName"]').eq(0).val(),
                        url: $('input[name="url"]').eq(0).val(),
                        _method: "put"
                    }, function (data) {
                        alert(data);
                    })
        ...
        <form action="${pageContext.request.contextPath}/permission/save.do"
            ...
            <section class="content"> <!--产品信息-->
                ...
                <div class="box-tools text-center">
                    <button type="button" class="btn bg-maroon" id="btn">保存</button>
